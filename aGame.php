...
<div class="container">
  ...
  <header>
    <nav class="secondary_header" id="menu">
      <ul>
        ...
        <li class="d12"  ><a  class="links hacked" href="products.html">PRODUCTS</a></li>
  ...
  <div class="row">
	<div class="columns">
	  ...
	  <div class="columns">
      <p onclick="location.href=''" class="thumbnail_align hacked"><button >ADD TO CART</button></p>
      
	</div>
  	<div class="columns">
      <p onclick="location.href=''" class="thumbnail_align"> Description </p>
